...
(
	...
	tipodoc		CHAR(3)		NOT NULL DEFAULT 'DNI', -- D = DNI / C = CARNET EXTRANJERIA 
	numerodoc	CHAR(12)		NOT NULL,
CONSTRAINT ck_tipodoc_tpersonas CHECK(tipodoc IN ('DNI','CAE'))
)
ENGINE  = INNODB;
...
CONSTRAINT uk_usuario_tusuarios UNIQUE (nombreusuario, claveacceso, nivelacceso)
)
ENGINE = INNODB;
